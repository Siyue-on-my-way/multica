...
type Issue struct {
	...
	ManualCheckpoint              []byte             `json:"manual_checkpoint"`
	ManualCheckpointVersion       int64              `json:"manual_checkpoint_version"`
	ManualCheckpointSource        string             `json:"manual_checkpoint_source"`
	ManualCheckpointUpdatedAt     pgtype.Timestamptz `json:"manual_checkpoint_updated_at"`
	DerivedSummary                []byte             `json:"derived_summary"`
	DerivedSummaryVersion         int64              `json:"derived_summary_version"`
	DerivedSummarySource          string             `json:"derived_summary_source"`
	DerivedSummaryUpdatedAt       pgtype.Timestamptz `json:"derived_summary_updated_at"`
	DerivedSummarySourceRevision  pgtype.Int8        `json:"derived_summary_source_revision"`
	DerivedSummarySourceCommentID pgtype.UUID        `json:"derived_summary_source_comment_id"`
	DerivedSummarySourceTaskID    pgtype.UUID        `json:"derived_summary_source_task_id"`
	DerivedSummaryLatencyMs       pgtype.Int4        `json:"derived_summary_latency_ms"`
	HandoffVersion                int64              `json:"handoff_version"`
}

type IssueAgentResultRead struct {
	IssueID               pgtype.UUID        `json:"issue_id"`
	UserID                pgtype.UUID        `json:"user_id"`
	LastSeenAgentResultAt pgtype.Timestamptz `json:"last_seen_agent_result_at"`
	UpdatedAt             pgtype.Timestamptz `json:"updated_at"`
}

...
func TestSupportedTypesMatchesMigrationWhitelist(t *testing.T) {
	want := map[string]bool{
		"claude": true, "codebuddy": true, "codex": true, "multica": true, "copilot": true,
		"opencode": true, "codearts": true, "deveco": true, "openclaw": true, "hermes": true,
		"pi": true, "cursor": true, "kimi": true, "reasonix": true, "dsh": true,
		"kiro": true, "antigravity": true, "qoder": true, "qoderclicn": true, "traecli": true,
		"grok": true, "qwen": true, "qwenpaw": true, "mcode": true, "dim": true,
		"zeroclaw": true,
	}
